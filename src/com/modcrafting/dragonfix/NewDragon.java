...
public class NewDragon extends EntityComplex{
    ...
    public NewDragon(World world) {
        ...
        this.children = new EntityComplexPart[] { 
        		this.h = new EntityComplexPart(this, "head", 6.0F, 6.0F), 
        		this.i = new EntityComplexPart(this, "body", 8.0F, 8.0F), 
        		this.j = new EntityComplexPart(this, "tail", 4.0F, 4.0F), 
        		this.by = new EntityComplexPart(this, "tail", 4.0F, 4.0F), 
        		this.bz = new EntityComplexPart(this, "tail", 4.0F, 4.0F), 
        		this.bA = new EntityComplexPart(this, "wing", 4.0F, 4.0F), 
        		this.bB = new EntityComplexPart(this, "wing", 4.0F, 4.0F)};
        this.a = 200;
    ...
    public void d() {
        ...
        if (this.health <= 0) {
            ...
            if (++this.f == this.e.length) this.f = 0;
            ...
            if (this.world.isStatic) {
                ...
                d0 = this.targetX - this.locX;
                d1 = this.targetY - this.locY;
                d2 = this.targetZ - this.locZ;
                d3 = d0 * d0 + d1 * d1 + d2 * d2;
                if (this.bI != null) {
                    this.targetX = this.bI.locX;
                    this.targetZ = this.bI.locZ;
                    double d4 = this.targetX - this.locX;
                    double d5 = this.targetZ - this.locZ;
                    ...
                    this.targetY = this.bI.boundingBox.b + d7;
                } else {
                    this.targetX += this.random.nextGaussian() * 2.0D;
                    this.targetZ += this.random.nextGaussian() * 2.0D;
                }

                if (this.bE || d3 < 100.0D || d3 > 22500.0D || this.positionChanged || this.G) this.k();
                ...
                Vec3D vec3d = Vec3D.a().create(this.targetX - this.locX, this.targetY - this.locY, this.targetZ - this.locZ).b();
            ...
            this.i.h_();
            this.i.setPositionRotation(this.locX + (double) (f11 * 0.5F), 
            		this.locY, this.locZ - (double) (f12 * 0.5F), 0.0F, 0.0F);
            this.bA.h_();
            this.bA.setPositionRotation(this.locX + (double) (f12 * 4.5F), 
            		this.locY + 2.0D, this.locZ + (double) (f11 * 4.5F), 0.0F, 0.0F);
            this.bB.h_();
            this.bB.setPositionRotation(this.locX - (double) (f12 * 4.5F), 
            		this.locY + 2.0D, this.locZ - (double) (f11 * 4.5F), 0.0F, 0.0F);
            ...
            this.h.h_();
            this.h.setPositionRotation(this.locX + (double) (f3 * 5.5F * f1), 
            		this.locY + (adouble1[1] - adouble[1]) * 1.0D + (double) (f9 * 5.5F), 
            		this.locZ - (double) (f13 * 5.5F * f1), 0.0F, 0.0F);
            for (int j = 0; j < 3; ++j) {
                EntityComplexPart entitycomplexpart = null;
                if (j == 0)entitycomplexpart = this.j;
                if (j == 1)entitycomplexpart = this.by;
                if (j == 2)entitycomplexpart = this.bz;
	...
	private void j() {
        if (this.bH != null) {
            if (this.bH.dead) {
                ...
                if (!event.isCancelled()) this.health += event.getAmount();
            }
        }
    ...
    private void k() {
        ...
        if (this.random.nextInt(2) == 0 && !this.world.players.isEmpty()) {
            ...
            do {
                ...
                double d0 = this.locX - this.targetX;
                double d1 = this.locY - this.targetY;
                double d2 = this.locZ - this.targetZ;
    ...
    public boolean a(EntityComplexPart entitycomplexpart, DamageSource damagesource, int i) {
        ...
        this.targetX = this.locX + (double) (f1 * 5.0F) + (double) ((this.random.nextFloat() - 0.5F) * 2.0F);
        this.targetY = this.locY + (double) (this.random.nextFloat() * 3.0F) + 1.0D;
        this.targetZ = this.locZ - (double) (f2 * 5.0F) + (double) ((this.random.nextFloat() - 0.5F) * 2.0F);
        this.bI = null;
